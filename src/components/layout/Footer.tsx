...
const socialLinks = [
  {
    ...
    label: "WhatsApp",
    icon: WhatsAppIcon,
    colorClass: "hover:text-whatsapp",
  },
  {
    href: "http://www.tiktok.com/@lolafrica0",
    label: "TikTok",
    icon: TikTokIcon,
    colorClass: "hover:text-white/80",
  },
  {
    href: "https://www.instagram.com/quikart_gh?igsh=MTZqNzNwNDdvam8wMw%3D%3D&utm_source=qr",
    label: "Instagram",
    icon: InstagramIcon,
    colorClass: "hover:text-instagram",
  },
  {
    href: "https://www.facebook.com/profile.php?id=100092412504647&mibextid=LQQJ4d",
    label: "Facebook",
    icon: Facebook,
    colorClass: "hover:text-facebook",
  },
];

export default function Footer() {
  return (
    <footer className="bg-primary text-primary-foreground py-8 border-t">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-primary-foreground mb-3">QuiKart</h3>
        ...
        <div className="text-center text-sm text-primary-foreground/80 mt-8 pt-8 border-t border-primary-foreground/20">
